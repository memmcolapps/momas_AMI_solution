...
export default function MeterManagementTable() {
  ...
  const [selectedMeterForView, setSelectedMeterForView] = useState<
    (typeof Meters)[0] | null
  >(null);
  const [selectedMeterForEdit, setSelectedMeterForEdit] =
    useState<MeterInventoryItem | null>(null);
  ...
  const mapMeterInventoryToMeterData = (
  ...
  const isAllSelected =
    selectedMeterIds.length === Meters.length && Meters.length > 0;
              ...
              >
                <TableCell className="px-4 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-gray-900">{meter.sn}</span>
                  </div>
                </TableCell>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem
                        onClick={() =>
                          handleEditMeter(mapMeterInventoryToMeterData(meter))
                        }
